...
This is **work-integrated learning**: you build, deploy, test, and submit **proof**. The assessment template is [`assessments/capstone.md`](../../assessments/capstone.md) — fill **Parts A–D**, not a long write-up.
...
Open [`capstone.md`](../../assessments/capstone.md) and draft:
