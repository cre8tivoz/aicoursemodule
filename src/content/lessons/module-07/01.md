...
This is **work-integrated learning**: you build, deploy, test, and submit **proof**. Use the **[evidence pack PDF](/downloads/capstone-evidence-pack.pdf)** or [online template](/downloads/capstone-evidence-pack) — fill **Parts A–D** as you go. Full guide: [`assessments/capstone.md`](../../assessments/capstone.md).
...
- [ ] **Part B** — one proof line per marking row (specific paths/elements)
